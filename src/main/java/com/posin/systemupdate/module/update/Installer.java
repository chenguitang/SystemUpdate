package com.posin.systemupdate.module.update;

import android.content.Context;

import com.posin.systemupdate.R;
import com.posin.systemupdate.utils.TelnetSuProc;
import com.posin.systemupdate.utils.Zip;
import com.posin.systemupdate.utils.Zip.UnzipListener;
...
public abstract class Installer extends MyThread {
    ...
    void unpackPackage() throws Exception {
        ...
        Zip.unzipFile(mPkgFile, mExtractPath.getAbsolutePath(), new UnzipListener() {
            @Override
